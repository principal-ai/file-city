...
exports.createDrawContext = createDrawContext;
exports.clearCanvas = clearCanvas;
function createDrawContext(ctx, width, height, cityData, padding = 40) {
    const { scale, offsetX, offsetZ } = calculateScaleAndOffset(cityData.bounds, width, height, padding);
...
function calculateScaleAndOffset(bounds, width, height, padding) {
